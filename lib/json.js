 ...
 */
const json = http_method => paramd => _.promise.make((self, done) => {
    const method = `json.${http_method}`;
    ...
    _.promise.make(self)
        .then(fetch[http_method].json.p(paramd.url, paramd.query || {}))
        ...
        .then(fetch.go)
        .then(_.promise.done(done, self, "headers,json"))
        .catch(done)
})
...
exports.json.get = json("get")
exports.json.put = json("put")
exports.json.patch = json("patch")
exports.json.post = json("post")
exports.json.delete = json("delete")
exports.json.head = json("head")
