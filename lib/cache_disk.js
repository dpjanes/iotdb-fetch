...
const _xxx = _.promise.denodeify(__xxx);
...
const _add_hash = _.promise.denodeify(__add_hash);
...
const _cache_get = _.promise.denodeify(__cache_get);
...
const _cache_put = _.promise.denodeify(__cache_put);
...
const _cache_merge = _.promise.denodeify(__cache_merge);
...
const _expire_cache_minimum = _.promise.denodeify(__expire_cache_minimum);
...
const _expire_cache_maximum = _.promise.denodeify(__expire_cache_maximum);
...
/**
 */
exports.cache_disk = _.promise.denodeify(cache_disk);
